...
interface DuckHuntGameplayHudOverlayProps {
...
export function DuckHuntGameplayHudOverlay({
  audioStatusLabel,
  bestScore,
  ...
  username,
  weaponLabel
}: DuckHuntGameplayHudOverlayProps) {
            ...
            <div className="flex items-center gap-3">
              ...
              {coopReadyActionAvailable ? (
                <Button
                  ...
                  className={
                    reticleHoveringReadyAction
                      ? "ring-2 ring-sky-300/70 shadow-[0_0_0_5px_rgb(56_189_248/0.18)]"
                      : undefined
                  }
