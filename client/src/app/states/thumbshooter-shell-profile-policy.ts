...
import { audioFoundationConfig, type BrowserAudioSession } from "../../audio";
...
interface ThumbShooterShellProfilePolicyDependencies {
...
interface ThumbShooterShellProfilePolicy {
...
export function useThumbShooterShellProfilePolicy({
  audioSession,
  browserStorage,
  dispatch,
  handTrackingRuntime,
  profileStorage,
  state
}: ThumbShooterShellProfilePolicyDependencies): ThumbShooterShellProfilePolicy {
  useEffect(() => {
